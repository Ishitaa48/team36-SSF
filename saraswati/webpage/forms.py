...
class user(forms.Form):
    choice = [('Select','Register as'),('teacher','Teacher'),('student','Student')]
    ...
    class_choice = [('Select','Select your class'),('9','IX'),('10','X'),('11','XI'),('12','XII')]
    class_nm = forms.ChoiceField(choices=class_choice)
...
class login_user(forms.Form):
    choice = [('Select','Login as'),('teacher','Teacher'),('student','Student')]
    login_as = forms.ChoiceField(choices=choice)
    user = forms.CharField(max_length=30, widget=forms.TextInput(attrs={"placeholder":"Username"}))
    password = forms.CharField(max_length=30, widget=forms.PasswordInput(attrs={"placeholder":"password"}))

class reset_psswrd(forms.Form):
    choice = [('Select','Select your Role'),('admin','Teacher'),('user','Student')]
